    ...
    <div className="min-h-screen bg-black text-zinc-300 font-sans selection:bg-[#7B2CBF]/30 selection:text-white">
      ...
      <nav className="relative z-10 w-full p-6 flex justify-between items-center border-b border-zinc-900/50 bg-black/50 backdrop-blur-md">
        <Link href="/" className="flex items-center gap-2 hover:opacity-80 transition-opacity">
          ...
          <span className="font-mono text-sm text-zinc-400">Volver a LogikaMobile</span>
        </Link>
      </nav>
      ...
      <main className="relative z-10 max-w-5xl mx-auto px-6 py-20 md:py-32 flex flex-col items-center">
        ...
        <div className="flex flex-col items-center text-center w-full mb-24">
          ...
          <p className="text-xl md:text-2xl text-zinc-400 max-w-3xl font-light leading-relaxed">
            ...
            <strong className="text-zinc-200 font-semibold block mt-4">Sin procesos lentos de contratación, sin costos ocultos. Tú decides el ritmo, nosotros escribimos el código.</strong>
          </p>
        </div>
        ...
        <div className="w-full mb-32">
          <div className="flex items-center gap-4 mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold text-white tracking-widest uppercase">
              Nuestro Ecosistema <span className="text-orange-500">de Servicios</span>
            </h2>
            <div className="h-px bg-zinc-800 flex-grow"></div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
            ...
            <div className="bg-zinc-950 border border-zinc-800 p-10 rounded-2xl relative overflow-hidden group hover:border-[#7B2CBF]/50 transition-colors">
              ...
              <h3 className="text-3xl font-bold text-white mb-6">Consultoría de Ingeniería</h3>
              <p className="text-zinc-400 text-lg leading-relaxed">
                Auditoría de código, diseño de arquitectura de software y decisiones técnicas estratégicas para que tu producto escale sobre bases sólidas.
              </p>
            </div>
            ...
            <div className="bg-zinc-950 border border-zinc-800 p-10 rounded-2xl relative overflow-hidden group hover:border-orange-500/50 transition-colors">
              ...
              <h3 className="text-3xl font-bold text-white mb-6">Infraestructura y Soporte</h3>
              <p className="text-zinc-400 text-lg leading-relaxed">
                Mantenimiento, monitoreo y soporte técnico bajo SLAs estrictos. Si no tienes infraestructura, la construimos desde cero.
              </p>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-br from-[#110524] to-black border border-[#7B2CBF]/30 p-10 md:p-16 rounded-3xl relative overflow-hidden shadow-[0_0_50px_rgba(123,44,191,0.1)]">
            ...
            <div className="max-w-3xl mb-16">
              ...
              <h3 className="text-4xl md:text-5xl font-extrabold text-white mb-6">Desarrollo Continuo</h3>
              <p className="text-zinc-300 text-xl leading-relaxed font-light mb-8">
                Construimos tus herramientas y soluciones a la medida mediante un sistema ágil de tickets.
              </p>
              ...
              <ul className="space-y-4 mb-10">
                <li className="flex items-start gap-4">
                  ...
                  <span className="text-lg text-zinc-300">Añade solicitudes a tu backlog.</span>
                </li>
                <li className="flex items-start gap-4">
                  <div className="mt-1 w-6 h-6 rounded-full bg-[#7B2CBF]/20 flex items-center justify-center shrink-0">
                    <div className="w-2 h-2 rounded-full bg-[#7B2CBF]"></div>
                  </div>
                  <span className="text-lg text-zinc-300">Trabajamos un ticket a la vez para garantizar foco, calidad y velocidad.</span>
                </li>
                <li className="flex items-start gap-4">
                  <div className="mt-1 w-6 h-6 rounded-full bg-[#7B2CBF]/20 flex items-center justify-center shrink-0">
                    <div className="w-2 h-2 rounded-full bg-[#7B2CBF]"></div>
                  </div>
                  <span className="text-lg text-zinc-300">Iteraciones claras y entregas predecibles.</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-black/50 border border-zinc-800/50 rounded-2xl p-8 backdrop-blur-sm">
              <h4 className="text-zinc-500 font-mono text-sm uppercase tracking-widest mb-8 text-center">Pipeline de Trabajo</h4>
              ...
              <div className="flex flex-col md:flex-row items-center justify-between gap-4 md:gap-2 relative">
                ...
                <div className="flex flex-col items-center gap-4 z-10">
                  ...
                  <span className="font-bold text-sm text-zinc-300">Solicitud</span>
                </div>
                ...
                <div className="flex flex-col items-center gap-4 z-10">
                  ...
                  <span className="font-bold text-sm text-[#7B2CBF]">Desarrollo</span>
                </div>
                ...
                <div className="flex flex-col items-center gap-4 z-10">
                  ...
                  <span className="font-bold text-sm text-orange-500">QA</span>
                </div>
                ...
                <div className="flex flex-col items-center gap-4 z-10">
                  ...
                  <span className="font-bold text-sm text-[#6CD3D3]">Entrega</span>
                </div>
                ...
                <div className="flex flex-col items-center gap-4 z-10">
                  ...
                  <span className="font-bold text-sm text-zinc-400">Cooldown</span>
                </div>
